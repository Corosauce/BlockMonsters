...
public class JobAttackRoutineBlockMonster1 extends JobBase implements IStructureUser {
	...
	//public List<StructurePiece> arms = new ArrayList<StructurePiece>();
	
	public JobAttackRoutineBlockMonster1(JobManager jm) {
		super(jm);
		//newBody();
	...
	@Override
	public void cleanup() {
		if (structureProfile != null) structureProfile.cleanup();
		super.cleanup();
	}
	
	@Override
	public void tickCustomMovement() {
		super.tickCustomMovement();
	...
	public boolean passBackAttackFrom(IStructureUser parPasser, DamageSource par1DamageSource, float par2, Vector3f coordsSource) {
		if (ent != null) {
			ent.attackEntityFrom(par1DamageSource, 0.5F);
